...
public class NotificationHelperHomeWork extends ContextWrapper {
    ...
    public NotificationHelperHomeWork(Context context) {
        super(context);
     ...
     */
    @TargetApi(Build.VERSION_CODES.O)
    public Notification.Builder getNotificationFollower(String title, String body, int currentNotificationID) {
        return new Notification.Builder(getApplicationContext(), FOLLOWERS_CHANNEL)
                .setContentTitle(title)
                .setContentText(body)
                .setSmallIcon(getSmallIcon())
                .setAutoCancel(true)
                .setContentIntent(getPendingIntent(currentNotificationID));
    }
     ...
     */
    @TargetApi(Build.VERSION_CODES.O)
    public Notification.Builder getNotificationDM( String title, String body, int currentNotificationID) {
     ...
     */
    private PendingIntent getPendingIntent(int currentNotificationID) {
        sessionDetailSchedule = new SessionDetailSchedule(this);
        Intent openMainIntent = new Intent(this, DetailHomeWork_activity.class);
        openMainIntent.putExtra("NOTIFID",""+ currentNotificationID);
