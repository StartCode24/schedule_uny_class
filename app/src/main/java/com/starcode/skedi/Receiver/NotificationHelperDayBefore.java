...
public class NotificationHelperDayBefore extends ContextWrapper {
    ...
    public NotificationHelperDayBefore(Context context) {
        super(context);
    ...
    private PendingIntent getPendingIntent() {
        ...
        Intent openMainIntent = new Intent(this, Home_activity.class);
