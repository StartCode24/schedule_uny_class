package com.starcode.skedi.database;
...
import com.starcode.skedi.model.AlarmModel.Colour;
import com.starcode.skedi.model.AlarmModel.Icon;
import com.starcode.skedi.model.AlarmModel.Reminder;

import java.util.ArrayList;
import java.util.List;

public class DatabaseHomeWorkHelper extends SQLiteOpenHelper {
    private static DatabaseHomeWorkHelper instance;
    ...
    public static synchronized DatabaseHomeWorkHelper getInstance(Context context) {
        if (instance == null) {
            instance = new DatabaseHomeWorkHelper(context.getApplicationContext());
        }
        return instance;
    }
     ...
     */
    private DatabaseHomeWorkHelper(Context context) {
    ...
    private void addAllIcons(SQLiteDatabase database) {
        String[] icons = context.getResources().getStringArray(R.array.int_colours_array);
