...
public class FeedSearchScheduleAll {
    ...
    public FeedSearchScheduleAll(int schedule_id, String start_time, String finish_time, String day_name, int day_number, String note, int guru_id, String guru_name, int mapel_id, String mapel_name, int kelas_id, String kelas_name, int jurusan_id, String jurusan_name, int room_id, String room_name) {
